...
static DEVICE_ATTR(update, S_IRUGO | S_IWUSR, read_ucode, fuse_ucode);
static DEVICE_ATTR(vr_data,	S_IRUGO | S_IWUSR, r_vr_data, w_vr_data);
static DEVICE_ATTR(version, S_IRUGO | S_IWUSR, version_show, NULL);
static DEVICE_ATTR(loglevel, S_IRUGO | S_IWUSR,	loglevel_show, loglevel_store);
static DEVICE_ATTR(power_en, S_IRUGO | S_IWUSR, power_status, power_control);
static DEVICE_ATTR(selftest, S_IRUGO | S_IWUSR, NULL, self_mode);
static DEVICE_ATTR(chipid, S_IRUGO | S_IWUSR, chipid_show, NULL);
